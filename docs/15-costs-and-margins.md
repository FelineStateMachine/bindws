...
A relay that spends its whole allowance costs the host about $1.61 a month, and rows written are $1.00 of that. Time awake is most of the rest. Storage is nearly free at these sizes.
...
The script projects a fleet from two shapes, a typical relay and a heavy one that passes its allowances and pays fuel, at a chosen share of heavy relays. At 1,000 relays and 5% heavy, the Cloudflare bill is about $420 a month, fuel brings in about $220, and the gap is the free tier. Rows written are the largest line on the bill, then duration, then object requests, which nobody pays for because traffic is free to relays.
